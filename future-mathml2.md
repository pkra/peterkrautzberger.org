...
In case it's still not clear, let me repeat myself: I care very much about MathML and the the mission of the Math Working Group [to facilitate and promote the use of the Web for mathematical and scientific communication](http://www.w3.org/Math/Documents/Charter2006.html). MathML has succeeded everywhere else but still struggles on the web.
