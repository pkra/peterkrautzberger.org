...
Here $\lim_ p$ is the usual limit along the ultrafilter $p$.
...
$${\color{blue}h}({\color{blue}k}-1) - {\color{blue}h}({\color{red}k}) \leq {\color{blue}h}({\color{red}k}-1) - {\color{blue}h}({\color{violet}f}({\color{red}k}-1)) \leq 1/4$$
by our choice of $h$.
